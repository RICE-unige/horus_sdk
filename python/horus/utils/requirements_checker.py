...
class RequirementsChecker:
    ...
    def get_backend_checks(self, backend_type):
        ...
        if backend_type not in self.backend_requirements:
            return [('Invalid Backend', lambda bt: (False, f'Unknown backend: {backend_type}'))]
    ...
    def check_backend(self, backend_type):
        ...
        if backend_type not in self.backend_requirements:
            return {'Invalid Backend': {'available': False, 'message': f'Unknown backend: {backend_type}'}}
    ...
    def _check_ros2_installation(self, backend_type):
        ...
        return False, "ROS2 not found - install with: sudo apt install ros-humble-desktop"
    ...
    def _check_ros1_installation(self, backend_type):
        ...
        return False, "ROS1 not found - install with: sudo apt install ros-noetic-desktop-full"
