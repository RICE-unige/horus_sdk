...
class RobotRegistryClient:
    ...
    def register_robot(self, robot, dataviz, timeout_sec: float = 10.0) -> Tuple[bool, Dict]:
        """
    ...
    def unregister_robot(self, robot_id: str, timeout_sec: float = 10.0) -> Tuple[bool, Dict]:
        """
    ...
    def _build_robot_config(self, robot, dataviz) -> RobotConfig:
        ...
        for viz in dataviz.visualizations:
            if viz.data_source.robot_name == robot.name:  # Only robot-specific visualizations
    ...
    def check_backend_availability(self) -> bool:
        ...
        return (self.register_client.service_is_ready() and 
                self.unregister_client.service_is_ready())
