...
class RobotDataSource(DataSource):
    ...
    def __init__(self, name: str, source_type: DataSourceType, topic: str, 
                 robot_name: str, frame_id: str = "map", **kwargs):
...
class VisualizationConfig:
    ...
    def __post_init__(self):
        ...
        if not self.display_name:
            source_desc = f"{self.data_source.robot_name}:" if self.data_source.robot_name else ""
            self.display_name = f"{source_desc}{self.data_source.name} ({self.viz_type.value})"
...
class DataViz:
    ...
    def add_sensor_visualization(self, sensor: SensorInstance, robot_name: str,
                               render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_robot_transform(self, robot_name: str, topic: str, frame_id: str = "map",
                          render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_robot_global_path(self, robot_name: str, topic: str, frame_id: str = "map",
                             render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_robot_local_path(self, robot_name: str, topic: str, frame_id: str = "map",
                            render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_robot_trajectory(self, robot_name: str, topic: str, frame_id: str = "map",
                           render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_occupancy_grid(self, topic: str, frame_id: str = "map",
                          render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_3d_map(self, topic: str, frame_id: str = "map",
                  render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_global_navigation_path(self, topic: str, frame_id: str = "map",
                                  render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_navigation_path(self, topic: str, frame_id: str = "map",
                           render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_tf_tree(self, topic: str = "/tf", frame_id: str = "map",
                   render_options: Optional[Dict[str, Any]] = None) -> None:
    ...
    def get_robot_visualizations(self, robot_name: str) -> List[VisualizationConfig]:
        ...
        return [viz for viz in self.visualizations 
    ...
    def get_global_visualizations(self) -> List[VisualizationConfig]:
        ...
        return [viz for viz in self.visualizations 
                if not viz.is_robot_specific()]
    
    def get_visualizations_by_type(self, viz_type: VisualizationType) -> List[VisualizationConfig]:
    ...
    def remove_robot_visualizations(self, robot_name: str) -> int:
        ...
        self.visualizations = [viz for viz in self.visualizations 
                             if viz.data_source.robot_name != robot_name]
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "robot_specific": len([v for v in self.visualizations if v.is_robot_specific()]),
    ...
    def _add_or_update_visualization(self, viz_config: VisualizationConfig) -> None:
        ...
        for i, existing in enumerate(self.visualizations):
            if (existing.data_source.name == viz_config.data_source.name and
