...
class Robot:
    ...
    def add_path_planning_to_dataviz(self, dataviz: 'DataViz', 
                                   global_path_topic: Optional[str] = None,
                                   local_path_topic: Optional[str] = None,
                                   trajectory_topic: Optional[str] = None) -> None:
        """
    ...
    def create_full_dataviz(self, dataviz_name: Optional[str] = None,
                           global_path_topic: Optional[str] = None,
                           local_path_topic: Optional[str] = None,
                           trajectory_topic: Optional[str] = None) -> 'DataViz':
        """
    ...
    def register_with_horus(self, dataviz: Optional['DataViz'] = None) -> Tuple[bool, Dict[str, Any]]:
        """
