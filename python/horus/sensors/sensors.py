...
class Camera(BaseSensor):
    ...
    def __init__(self, name: str, frame_id: str, topic: str, 
                 is_stereo: bool = False, resolution: tuple[int, int] = (640, 480),
                 fps: int = 30, fov: float = 60.0, encoding: str = "bgr8", **kwargs):
...
class LaserScan(BaseSensor):
    ...
    def __init__(self, name: str, frame_id: str, topic: str,
                 min_angle: float = -3.14159, max_angle: float = 3.14159,
                 angle_increment: float = 0.005, min_range: float = 0.1,
                 max_range: float = 30.0, range_resolution: float = 0.01, **kwargs):
...
class Lidar3D(BaseSensor):
    ...
    def __init__(self, name: str, frame_id: str, topic: str,
                 vertical_fov: float = 40.0, horizontal_fov: float = 360.0,
                 vertical_resolution: float = 0.4, horizontal_resolution: float = 0.4,
                 min_range: float = 0.5, max_range: float = 100.0,
                 points_per_second: int = 1000000, num_layers: int = 64, **kwargs):
