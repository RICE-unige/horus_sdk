...
def main():
    ...
    for robot in fleet:
        master_dataviz.add_robot_transform(
            robot_name=robot.name, topic=f"/{robot.name}/tf"
        )
